  ...
  series: [
    {
      ...
      data: [
        ...
        {name: '上市', value: Math.round(Math.random() * 100)},
...
export default class Home extends Component {
  state = {showMap: false, trigger: true}
  componentDidMount() {
    fetch('/json/china.json').then(res => res.json()).then(json => {
  ...
  onClick(params) {
    ...
    fetch(`/json/province/${params.name}.json`).then(res => res.json()).then(json => {
